class AttendeesController < ApplicationController
  ...
  def new
    ...
    @attendee.medications.build
  end

  # GET /attendees/1/edit
  def edit
    # @medications = @medications.present? ? @medications : @medications.build
  end
  ...
  private
    ...
    def attendee_params
      params.require(:attendee).permit(:name, :phone, :address, :city, :state, :zip, medications_attributes: [:id, :name, :strength, :_destroy])
    end
end
