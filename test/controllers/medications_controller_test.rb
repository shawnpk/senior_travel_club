...
class MedicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medication" do
    assert_difference('Medication.count') do
      post medications_url, params: { medication: { attendee_id: @medication.attendee_id, name: @medication.name, strength: @medication.strength } }
    end
  ...
  test "should update medication" do
    patch medication_url(@medication), params: { medication: { attendee_id: @medication.attendee_id, name: @medication.name, strength: @medication.strength } }
