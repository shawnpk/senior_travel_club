...
class AttendeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendee" do
    assert_difference('Attendee.count') do
      post attendees_url, params: { attendee: { address: @attendee.address, city: @attendee.city, name: @attendee.name, phone: @attendee.phone, state: @attendee.state, zip: @attendee.zip } }
    end
  ...
  test "should update attendee" do
    patch attendee_url(@attendee), params: { attendee: { address: @attendee.address, city: @attendee.city, name: @attendee.name, phone: @attendee.phone, state: @attendee.state, zip: @attendee.zip } }
